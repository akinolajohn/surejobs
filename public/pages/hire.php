...
<head>
    ...
    <!-- Document CSS -->
    <link href="../assets/css/hire.css" media="all" rel="stylesheet" type="text/css">

    <!-- Document Title -->
    <title> Sure Jobs | Hire Artisans </title>
</head>
...
<body>
    ...
    <!-- Document Script -->
    <script src="../assets/js/hire.js" type="text/javascript"> </script>
</body>
