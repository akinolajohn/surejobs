...
<head>
    ...
    <!-- Document CSS -->
    <link href="../assets/css/work.css" media="all" rel="stylesheet" type="text/css">

    <!-- Document Title -->
    <title> Sure Jobs | Find Work </title>
</head>
...
<body>
    ...
    <!-- Document Script -->
    <script src="../assets/js/work.js" type="text/javascript"> </script>
</body>
