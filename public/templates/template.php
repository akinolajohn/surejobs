<!-- --- NOTE ---
            This file simply acts as a template.
-->
...
<head>
    ...
    <!-- Document CSS -->
    <link href="assets/css/<<documentName>>.css" media="all" rel="stylesheet" type="text/css">
...
<body>
    ...
    <!-- Document Script -->
    <script src="assets/js/<<documentName>>.js" type="text/javascript"> </script>
</body>
